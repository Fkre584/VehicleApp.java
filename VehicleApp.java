...
class Vehicle {
    protected String brand; // በልጅ ክላሶች እንዲታይ protected ተደርጓል
    private String model;   // በዚሁ ክላስ ብቻ እንዲታይ private ተደርጓል
    ...
    // ይህ ሜተድ override እንዳይሆን final ተደርጓል
...
class Car extends Vehicle {
    ...
    public Car(String brand, String model, int doorCount) {
        super(brand, model); // የወላጅ ክላስ ኮንስትራክተር መጥራት
